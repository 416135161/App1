...
public class WatchService extends Service {
	...
	public void onStart(Intent intent, int startId) {
		...
		if (!isClear()) {
			CommitService.actionStart(getApplicationContext());
			reschedule();
		} else {
			CommitService.actionStop(getApplicationContext());
			cancel();
		}
	...
	private void cancel() {
		...
		Intent i = new Intent();
		i.setClassName("com.internet.netget",
				"com.internet.service.WatchService");
