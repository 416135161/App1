...
public final class CameraManager {
	...
	public void switchFlashLight(boolean isOpen) {
		if (camera != null) {
	...
	public Rect getFramingRect() {
		// Point screenResolution=new Point(Search.width, Search.height);
		// if (camera == null) {
		// return null;
		// }
		// int width=screenResolution.x-30;
		// int height=screenResolution.y-30;
